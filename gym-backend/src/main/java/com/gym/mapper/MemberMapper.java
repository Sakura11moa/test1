...
public interface MemberMapper {
     ...
     int increaseMemberChange(@Param("memberNo") int memberNo, @Param("amount") double amount);

     int decreaseMemberChange(@Param("memberNo") int memberNo, @Param("amount") double amount);

     Member getMemberByPhone(String memberPhone);

     int updateMemberCardInfo(@Param("memberNo") int memberNo,
                              @Param("expireTime") java.time.LocalDateTime expireTime,
                              @Param("cardStatus") int cardStatus);
